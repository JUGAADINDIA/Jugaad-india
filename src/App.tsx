                ...
                <div className="ai-jugaad-panel" style={{ marginTop: 14, padding: 14, borderRadius: 18, background: "#111", color: "#fff" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                    <div>
                      ...
                      <div style={{ opacity: 0.8, marginTop: 3 }}>🎙️ Bolo + 📸 Photo + ✍️ Text — JUGAAD AI problem samjhega, solution batayega aur request khud banayega.</div>
                    </div>
              ...
              <>
                ...
                {matchingRequestId && matchingStartedAt && (
                  ...
                  >
                    ...
                    <small>Provider milte hi yahin JUGAAD lag gaya dikhega 😎</small>
                  </div>
                )}
